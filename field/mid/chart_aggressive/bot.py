...
"""Chart Aggressive — preflop hand-chart + postflop handtype.
...
Parameters: chart_tightness=0.52, cbet_freq=0.85
"""
...
CHART_TIGHTNESS = 0.52   # 0.55-0.65 typical
CBET_FREQ = 0.85
