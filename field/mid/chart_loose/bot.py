...
"""Chart Loose — preflop hand-chart + postflop handtype.
...
Parameters: chart_tightness=0.48, cbet_freq=0.7
"""
...
CHART_TIGHTNESS = 0.48   # 0.55-0.65 typical
CBET_FREQ = 0.7
