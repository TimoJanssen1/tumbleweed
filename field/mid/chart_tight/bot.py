...
"""Chart Tight — preflop hand-chart + postflop handtype.
...
Parameters: chart_tightness=0.62, cbet_freq=0.65
"""
...
CHART_TIGHTNESS = 0.62   # 0.55-0.65 typical
CBET_FREQ = 0.65
