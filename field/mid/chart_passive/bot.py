...
"""Chart Passive — preflop hand-chart + postflop handtype.
...
Parameters: chart_tightness=0.58, cbet_freq=0.4
"""
...
CHART_TIGHTNESS = 0.58   # 0.55-0.65 typical
CBET_FREQ = 0.4
