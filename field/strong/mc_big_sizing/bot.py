...
"""MC Big Sizing — real-time MC equity vs estimated range.

Tier: strong
Strategy: classic equity-based TAG. Preflop chart + MC postflop equity.
Parameters: open_thresh=0.58, three_bet_thresh=0.72,
            cbet_freq=0.65, n_trials=180.
"""
