...
"""MC Loose LAG — real-time MC equity vs estimated range.

Tier: strong
Strategy: classic equity-based TAG. Preflop chart + MC postflop equity.
Parameters: open_thresh=0.5, three_bet_thresh=0.66,
            cbet_freq=0.78, n_trials=180.
"""
